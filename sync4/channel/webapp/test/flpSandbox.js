			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chnchannel-display": {
								"semanticObject": "chnchannel",
								"action": "display",
								"description": "대리점 매니저용 관리 프로그램",
								"title": "대리점 관리 프로그램",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chn.channel",
									"url": sap.ui.require.toUrl("chn/channel")
								}
							}
						}
					}
