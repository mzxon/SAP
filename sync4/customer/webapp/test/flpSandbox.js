		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "렌탈 거래 프로그램",
									"targetURL": "#custcustomer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"custcustomer-display": {
								"semanticObject": "custcustomer",
								"action": "display",
								"description": "렌탈 거래 프로그램",
								"title": "렌탈 거래 프로그램",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cust.customer",
									"url": sap.ui.require.toUrl("cust/customer")
								}
							}
						}
					}
