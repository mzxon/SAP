		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Grid CRUD",
									"targetURL": "#sync4c1fioriedu09-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu09-display": {
								"semanticObject": "sync4c1fioriedu09",
								"action": "display",
								"description": "Fiori Grid CRUD Training",
								"title": "Fiori Grid CRUD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu09",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu09")
								}
							}
						}
					}
