		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Micro Donut Chart with OData",
									"targetURL": "#sync4c1fioriedu12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu12-display": {
								"semanticObject": "sync4c1fioriedu12",
								"action": "display",
								"description": "Micro Donut Chart with OData",
								"title": "Micro Donut Chart with OData",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu12",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu12")
								}
							}
						}
					}
