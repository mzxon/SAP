		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BarChart Training",
									"targetURL": "#syncc1fioriedu13-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc1fioriedu13-display": {
								"semanticObject": "syncc1fioriedu13",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c1.fioriedu13",
									"url": sap.ui.require.toUrl("sync/c1/fioriedu13")
								}
							}
						}
					}
