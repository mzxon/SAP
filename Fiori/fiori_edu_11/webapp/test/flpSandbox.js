		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart_Donut, Line, Bar",
									"targetURL": "#sync4c1fioriedu11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu11-display": {
								"semanticObject": "sync4c1fioriedu11",
								"action": "display",
								"description": "ChartTraining",
								"title": "Chart_Donut, Line, Bar",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu11",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu11")
								}
							}
						}
					}
