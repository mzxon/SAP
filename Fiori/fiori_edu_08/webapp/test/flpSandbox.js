		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync4c1fioriedu08-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu08-display": {
								"semanticObject": "sync4c1fioriedu08",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu08",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu08")
								}
							}
						}
					}
