		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Table List",
									"targetURL": "#sync4c1fioriedu04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu04-display": {
								"semanticObject": "sync4c1fioriedu04",
								"action": "display",
								"description": "JSON Data Table List",
								"title": "JSON Table List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu04",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu04")
								}
							}
						}
					}
