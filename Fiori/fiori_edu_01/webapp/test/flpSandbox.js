		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync4fioriedu01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4fioriedu01-display": {
								"semanticObject": "sync4fioriedu01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.fioriedu01",
									"url": sap.ui.require.toUrl("sync4/fioriedu01")
								}
							}
						}
					}
