		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#syncc1fioriedut01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc1fioriedut01-display": {
								"semanticObject": "syncc1fioriedut01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c1.fioriedut01",
									"url": sap.ui.require.toUrl("sync/c1/fioriedut01")
								}
							}
						}
					}
