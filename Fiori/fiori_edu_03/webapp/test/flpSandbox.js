		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Review",
									"targetURL": "#sync4c1fioriedu03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu03-display": {
								"semanticObject": "sync4c1fioriedu03",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu03",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu03")
								}
							}
						}
					}
