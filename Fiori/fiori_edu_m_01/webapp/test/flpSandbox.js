		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FioriTraining",
									"targetURL": "#sync4c1fioriedum01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedum01-display": {
								"semanticObject": "sync4c1fioriedum01",
								"action": "display",
								"description": "FioriTraining",
								"title": "FioriTraining",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedum01",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedum01")
								}
							}
						}
					}
