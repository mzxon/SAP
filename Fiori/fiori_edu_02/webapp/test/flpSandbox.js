		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Training 2",
									"targetURL": "#fioriedu02sync4c1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriedu02sync4c1-display": {
								"semanticObject": "fioriedu02sync4c1",
								"action": "display",
								"description": "Fiori Education",
								"title": "Fiori Training 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriedu02.sync4.c1",
									"url": sap.ui.require.toUrl("fioriedu02/sync4/c1")
								}
							}
						}
					}
