		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Grid For Study",
									"targetURL": "#sync4c1fioriedum02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedum02-display": {
								"semanticObject": "sync4c1fioriedum02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedum02",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedum02")
								}
							}
						}
					}
