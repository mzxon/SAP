		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CDS Service Training",
									"targetURL": "#sync4c1fioriedu07-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu07-display": {
								"semanticObject": "sync4c1fioriedu07",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu07",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu07")
								}
							}
						}
					}
