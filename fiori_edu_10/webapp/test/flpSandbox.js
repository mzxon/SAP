		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync4c1fioriedu10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu10-display": {
								"semanticObject": "sync4c1fioriedu10",
								"action": "display",
								"description": "Steel Info",
								"title": "Fiori Training",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu10",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu10")
								}
							}
						}
					}
