		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Viz Column Chart",
									"targetURL": "#sync4c1fioriedu14-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu14-display": {
								"semanticObject": "sync4c1fioriedu14",
								"action": "display",
								"description": "Viz ColumnChart with CDS OData",
								"title": "Viz Column Chart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu14",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu14")
								}
							}
						}
					}
