		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "VizFrame Chart",
									"targetURL": "#sync4c1vizchartedu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1vizchartedu-display": {
								"semanticObject": "sync4c1vizchartedu",
								"action": "display",
								"description": "VizFrame Chart(Column, Pie, Line, Bar) with CDS OData",
								"title": "VizFrame Chart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.vizchartedu",
									"url": sap.ui.require.toUrl("sync4/c1/vizchartedu")
								}
							}
						}
					}
