		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Airline Master by Gateway",
									"targetURL": "#sync4c1fioriedu05-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu05-display": {
								"semanticObject": "sync4c1fioriedu05",
								"action": "display",
								"description": "Airline Master",
								"title": "Airline Master by Gateway",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu05",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu05")
								}
							}
						}
					}
