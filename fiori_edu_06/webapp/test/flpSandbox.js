		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IdolMember",
									"targetURL": "#sync4c1fioriedu06-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync4c1fioriedu06-display": {
								"semanticObject": "sync4c1fioriedu06",
								"action": "display",
								"description": "Idol~",
								"title": "IdolMember",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync4.c1.fioriedu06",
									"url": sap.ui.require.toUrl("sync4/c1/fioriedu06")
								}
							}
						}
					}
